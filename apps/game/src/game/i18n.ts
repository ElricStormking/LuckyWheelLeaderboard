...
const COPY: Record<AppLocale, Record<CopyKey, string>> = {
  en: {
    ...
    "lobby.stepDepositCopy": "Merchant API returns customer-platform spin quota.",
    "lobby.stepSpinTitle": "Spin",
    "lobby.stepSpinCopy": "The API resolves the segment.",
    "lobby.stepRankTitle": "Rank Up",
    "lobby.stepRankCopy": "Leaderboard and totals refresh live.",
    ...
    "lobby.eligibilityLine": "{buttonLabel} - {remaining}/{granted} spins left",
  ...
  ms: {
    ...
    "lobby.stepDepositTitle": "Deposit",
    "lobby.stepDepositCopy": "Merchant API memulangkan kuota putaran dari Customer Platform.",
    "lobby.stepSpinTitle": "Putar",
    "lobby.stepSpinCopy": "API menentukan segmen akhir.",
    "lobby.stepRankTitle": "Naik Rank",
    "lobby.stepRankCopy": "Kedudukan dan jumlah mata dikemas kini secara langsung.",
    ...
    "lobby.eligibilityLine": "{buttonLabel} - baki {remaining}/{granted} putaran",

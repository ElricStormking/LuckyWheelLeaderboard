...
const DESKTOP_EDITOR_UI_TEXTURES: Record<string, string> = {
  ...
  Desktop_CopyrightBlock: "../UI/PC_UI/Main/CopyrightBlock_all.png",
  Desktop_CopyrightText: "../UI/PC_UI/Main/CopyrightBlock_CopyrightText_0.png",
  Desktop_LicenseText: "../UI/PC_UI/Main/CopyrightBlock_LicenseText_0.png",
